...
class ClickDebouncer {
  ...
  /// framework already.
  void onClick(
      DomEvent click, int viewId, int semanticsNodeId, bool isListening) {
...
class _PointerAdapter extends _BaseAdapter with _WheelEventListenerMixin {
  ...
  void _convertEventsToPointerData({
    ...
    final ui.Offset offset =
        computeEventOffsetToTarget(event, _view, eventTarget: eventTarget);
    _pointerDataConverter.convert(
      data,
      viewId: _view.viewId,
